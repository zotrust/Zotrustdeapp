import{I as p,F as u,R as f,Y as g,G as d}from"./index-BFI8d_nw.js";import{n as b,r as m,c as w}from"./index-CCwJfBJe.js";import{T as l}from"./index-C-qroGLZ.js";const C={interpolate(r,e,t){if(r.length!==2||e.length!==2)throw new Error("inputRange and outputRange must be an array of length 2");const n=r[0]||0,i=r[1]||0,o=e[0]||0,s=e[1]||0;return t<n?o:t>i?s:(s-o)/(i-n)*(t-n)+o}},v=p`
  :host {
    width: 100%;
    display: block;
  }
