...
class ContractService {
    constructor() {
        ...
        // Real deployed contract ABI (from 0x878A2a0d3452533F7a2cB0E3053258AB66C03d0F)
        const contractABI = [
            {
                "inputs": [
                    {
            ...
            },
            {
                ...
                "outputs": [
                    ...
                    {
                        "internalType": "enum P2PEscrowV2.Status",
                        "name": "status",
                        "type": "uint8"
                    },
                    {
        ...
        const contractAddress = process.env.CONTRACT_ADDRESS || '0x878A2a0d3452533F7a2cB0E3053258AB66C03d0F';
