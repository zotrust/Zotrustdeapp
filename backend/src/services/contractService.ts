...
export class ContractService {
  ...
  constructor() {
    ...
    // Real deployed contract ABI (from 0x02ADD84281025BeeB807f5b94Ea947599146ca00)
    ...
    const contractAddress = process.env.CONTRACT_ADDRESS || '0x02ADD84281025BeeB807f5b94Ea947599146ca00';
    ...
    try {
      ...
      try {
        ...
        if (balance < estimatedCost) {
          ...
          const shortfallBNB = ethers.formatEther(shortfall);
          throw new Error(
            `INSUFFICIENT_FUNDS: Relayer wallet has insufficient BNB for gas fees. ` +
