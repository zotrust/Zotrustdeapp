import{I as U,F as h,Y as D,O as H,G as c,X as V,a1 as k,aA as F,y as R,A as P,D as M,n as E,aB as w,i as $,j as I,M as z,E as C,P as _,W as A,S as Y,R as K}from"./index-D5A4eE5t.js";import{r as y,c as f,n as l}from"./index-C8C6iNup.js";import"./index-C6mr-7Lc.js";import{e as G,n as L}from"./ref-DLQaX2o7.js";import"./index-Bx4IN8LE.js";import{H as N}from"./HelpersUtil-Gb5CriGa.js";import{o as X}from"./if-defined-DGGI3T02.js";import"./index-bVoAqo5m.js";import"./index-C_lgZUzI.js";import"./index-Ca9KrC0b.js";import"./index-BCisVdxP.js";import"./index-_k21ES3q.js";import{N as q}from"./NavigationUtil-DmfK5sOV.js";const Q=U`
  div {
    width: 100%;
  }
...
`;var B=function(e,t,i,r){var n=arguments.length,o=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(n<3?s(o):n>3?s(t,i,o):s(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};const T=600,W=360,Z=64;let S=class extends h{constructor(){super(),this.bodyObserver=void 0,this.unsubscribe=[],this.iframe=document.getElementById("w3m-iframe"),this.ready=!1,this.unsubscribe.push(D.subscribeKey("open",t=>{t||this.onHideIframe()}),D.subscribeKey("shake",t=>{t?this.iframe.style.animation="w3m-shake 500ms var(--apkt-easings-ease-out-power-2)":this.iframe.style.animation="none"}))}disconnectedCallback(){var t;this.onHideIframe(),this.unsubscribe.forEach(i=>i()),(t=this.bodyObserver)==null||t.unobserve(window.document.body)}async firstUpdated(){var i;await this.syncTheme(),this.iframe.style.display="block";const t=(i=this==null?void 0:this.renderRoot)==null?void 0:i.querySelector("div");this.bodyObserver=new ResizeObserver(r=>{var s,a;const n=(s=r==null?void 0:r[0])==null?void 0:s.contentBoxSize,o=(a=n==null?void 0:n[0])==null?void 0:a.inlineSize;this.iframe.style.height=`${T}px`,t.style.height=`${T}px`,H.state.enableEmbedded?this.updateFrameSizeForEmbeddedMode():o&&o<=430?(this.iframe.style.width="100%",this.iframe.style.left="0px",this.iframe.style.bottom="0px",this.iframe.style.top="unset",this.onShowIframe()):(this.iframe.style.width=`${W}px`,this.iframe.style.left=`calc(50% - ${W/2}px)`,this.iframe.style.top=`calc(50% - ${T/2}px + ${Z/2}px)`,this.iframe.style.bottom="unset",this.onShowIframe())}),this.bodyObserver.observe(window.document.body)}render(){return c`<div data-ready=${this.ready} id="w3m-frame-container"></div>`}onShowIframe(){const t=window.innerWidth<=430;this.ready=!0,this.iframe.style.animation=t?"w3m-iframe-zoom-in-mobile 200ms var(--apkt-easings-ease-out-power-2)":"w3m-iframe-zoom-in 200ms var(--apkt-easings-ease-out-power-2)"}onHideIframe(){this.iframe.style.display="none",this.iframe.style.animation="w3m-iframe-fade-out 200ms var(--apkt-easings-ease-out-power-2)"}async syncTheme(){const t=V.getAuthConnector();if(t){const i=k.getSnapshot().themeMode,r=k.getSnapshot().themeVariables;await t.provider.syncTheme({themeVariables:r,w3mThemeVariables:F(r,i)})}}async updateFrameSizeForEmbeddedMode(){var r;const t=(r=this==null?void 0:this.renderRoot)==null?void 0:r.querySelector("div");await new Promise(n=>{setTimeout(n,300)});const i=this.getBoundingClientRect();t.style.width="100%",this.iframe.style.left=`${i.left}px`,this.iframe.style.top=`${i.top}px`,this.iframe.style.width=`${i.width}px`,this.iframe.style.height=`${i.height}px`,this.onShowIframe()}};S.styles=Q;B([y()],S.prototype,"ready",void 0);S=B([f("w3m-approve-transaction-view")],S);const J=R`
  a {
    border: none;
...
`;var b=function(e,t,i,r){var n=arguments.length,o=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(n<3?s(o):n>3?s(t,i,o):s(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};let u=class extends h{constructor(){var t;super(),this.formRef=G(),this.usubscribe=[],this.name="",this.error="",this.loading=w.state.loading,this.suggestions=w.state.suggestions,this.profileName=(t=$.getAccountData())==null?void 0:t.profileName,this.onDebouncedNameInputChange=I.debounce(i=>{i.length<4?this.error="Name must be at least 4 characters long":N.isValidReownName(i)?(this.error="",w.getSuggestions(i)):this.error="The value is not a valid username"}),this.usubscribe.push(w.subscribe(i=>{this.suggestions=i.suggestions,this.loading=i.loading}),$.subscribeChainProp("accountState",i=>{this.profileName=i==null?void 0:i.profileName,i!=null&&i.profileName&&(this.error="You already own a name")}))}firstUpdated(){var t;(t=this.formRef.value)==null||t.addEventListener("keydown",this.onEnterKey.bind(this))}disconnectedCallback(){var t;super.disconnectedCallback(),this.usubscribe.forEach(i=>i()),(t=this.formRef.value)==null||t.removeEventListener("keydown",this.onEnterKey.bind(this))}render(){return c`
    ...
    `}onNameInputChange(t){const i=N.validateReownName(t.detail||"");this.name=i,this.onDebouncedNameInputChange(i)}onKeyDown(t){t.key.length===1&&!N.isValidReownName(t.key)&&t.preventDefault()}templateSuggestions(){return!this.name||this.name.length<4||this.error?null:c`<wui-flex flexDirection="column" gap="1" alignItems="center">
